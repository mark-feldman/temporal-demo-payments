...
6. **`UNKNOWN_BANK_STATUS` must not compensate.** The bank accepted and never confirmed;
   releasing the reservation could pay out twice. Mark it, make it searchable, route to a human.
